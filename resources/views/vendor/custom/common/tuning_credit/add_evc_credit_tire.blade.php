...
@php
  $defaultBreadcrumbs = [
    ...
    trans('EVC Tuning credits') => url('tuning-evc-credit'),
...
@section('header')
	<section class="container-fluid">
	  <h2>
        ...
        <small><a href="{{ url('tuning-evc-credit') }}" class="d-print-none font-sm"><i class="la la-angle-double-{{ config('backpack.base.html_direction') == 'rtl' ? 'right' : 'left' }}"></i> {{ trans('backpack::crud.back_to_all') }} <span>evc tuning credit prices</span></a></small>
	  </h2>
	</section>
@endsection
