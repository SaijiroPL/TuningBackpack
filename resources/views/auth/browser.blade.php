...
@section('content')
<style>
    .container{display:flex; width:100%; flex-wrap:wrap;align-items:center;}
    .drop-down-container { overflow: hidden; margin-bottom: 10px; display: flex; flex-wrap:wrap }
    .drop-down { max-width: 25%; flex: 0 0 25%; padding-right: 10px; padding-bottom: 8px; position: relative; }
    #btnFind { width: calc(100% - 10px); }
    .box-header { padding: 10px; }
    @media (max-width: 1100px) {
        .drop-down { max-width: 50%; flex: 0 0 50%; }
    }
    @media (max-width: 700px) {
        .drop-down { max-width: 100%; flex: 0 0 100%; }
    }
</style>
