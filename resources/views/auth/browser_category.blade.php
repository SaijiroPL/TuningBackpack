...
@section('content')
<style>
.container{display:flex; width:100%; flex-wrap:wrap; align-items:center; padding: 15px}
.subitem-link:hover {
            ...
            <div class="box-body reg-box">
                ...
                <div class="row" style="margin-top: 30px">
                    @foreach($subitems as $si)
                        ...
                        @elseif($mode == 'model')
                        <a href="{{ route('browser.category', ['make' => $brand, 'model' => $title, 'generation' => $si]) }}" class="subitem-link">
                            {{ $si }}
                        </a>
                        @elseif($mode == 'generation')
                        <a href="{{ route('browser.category', ['make' => $brand, 'model' => $model, 'generation' => $title, 'engine' => $si->id]) }}" class="subitem-link">
